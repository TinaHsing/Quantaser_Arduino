...
//sherry++ 2017.9.25
#define SERIAL_MAX_INPUT_NUM    15

//sherry++ 2017.9.26
#define SERIAL_CMD_IDN      "IDN?"
#define SERIAL_CMD_REM      "REM:"
#define SERIAL_CMD_UREM     "UREM:"
#define SERIAL_CMD_TSET     "TSET:"
#define SERIAL_CMD_TACT     "TACT?"
#define SERIAL_CMD_START    "START:"
#define SERIAL_CMD_STOP     "STOP:"
#define REMOTE_IDN_TEXT     "DTC03IB"

//sherry++ 2017.9.26
#define REMOTE_TSET_MAX     61912       //7
#define REMOTE_TSET_MIN     1728        //100
...
public:
    ...
    void CheckSerial();
    //sherry++ 2017.9.25
    void SerialInit(bool bFromSetup);
...
private:
    ...
    //sherry++ 2017.9.25
    unsigned int ucInputNum = 0;
    //sherry++ 2017.9.26
    bool bRemoteMode = false;
    char cInputStr[SERIAL_MAX_INPUT_NUM + 1];
