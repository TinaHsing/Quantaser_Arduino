...
void led4X7_disp::print(float number) { //use delay method, test fix number
...
void led4X7_disp::OnReceiveEvent()
{
...
//        g_pztEn = temp[0];
//        Serial.println(F("EN:"));
//        Serial.println(g_pztEn);
//      break;
    }
  }
}
void led4X7_disp::OnRequestEvent()
{
  unsigned char com,temp[2];
  unsigned int pztMon;
