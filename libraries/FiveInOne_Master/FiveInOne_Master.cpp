...
//		else temp[1] &= REQMSK_SENSTYPE;
    ...
    case I2C_COM_KI:
    	switch(slaveAdd)
        {
        	...
        	break;
        	case DTC03P05_2:
        		temp[0]=pgm_read_word_near(kilstable230+g_kiindex2*2);
        		temp[1]=pgm_read_word_near(kilstable230+g_kiindex2*2+1);
        	break;
		}        
        break;
...
void DTC03Master::PrintTact(float tact)
{
  ...
  if(g_errcode1) 
   ...
   if(tact<10.000) lcd.print(" ");  
   if(tact>=100.00) lcd.print(tact,2); 
   else lcd.print(tact,3);
...
//        break;
      ...
      case 10:
	    ...
	    if(g_r1<1) g_r1=1;//
      	...
      	I2CWriteData(I2C_COM_R1R2,DTC03P05_2);
        PrintR1();
      ...
      case 12:
        ...
        I2CWriteData (I2C_COM_TPIDOFF,DTC03P05_2);
        PrintTpidoff();
      ...
      case 13:
        ...
        I2CWriteData(I2C_COM_FBC,DTC03P05_2);
        PrintVfbc();
      ...
      case 15:
        ...
        I2CWriteData(I2C_COM_RMEAS,DTC03P05_2);
        PrintRmeas();
      ...
      case 16:
		...
		I2CWriteData(I2C_COM_OTP,DTC03P05_2);
        PrintTotp();  
