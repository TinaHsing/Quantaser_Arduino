/*==============================================================================
  ...
  * Part:						Si5341 Rev D
  * Design ID:                                          
  * Includes Pre/Post process:	Yes
  * Created By:					ClockBuilder Pro v2.20 [2017-11-21]
  * Timestamp:					2023-05-03 10:36:43 GMT+08:00
  *
  ==============================================================================
  *
...
#ifndef _SI5341_REG_H_
#define _SI5341_REG_H_

#define SI5341_PRE_NUM				6
#define SI5341_REG_NUM				378
#define SI5341_POST_NUM				3
...
const si5341_reg_t Si5341_Preamble[SI5341_PRE_NUM] =
{
...
const si5341_reg_t Si5341_Register[SI5341_REG_NUM] =
{
...
const si5341_reg_t Si5341_Postambl[SI5341_POST_NUM] =
{
 ...
 * ========
 * Part:         Si5341 Rev D
 * Project File: D:\Project Data\QSS021\HTG-ZRF8-4\Si5341\Si5341_mcs.slabtimeproj
 * Design ID:    <none>
 * Created By:   ClockBuilder Pro v2.20 [2017-11-21]
 * Timestamp:    2023-05-03 10:36:43 GMT+08:00
 * 
 ...
 * Device Grade
 * ============
 * Maximum Output Frequency: 200.08 MHz
 ...
 * 
 * Outputs:
 *    OUT0: 100.04 MHz [ 100 + 1/25 MHz ]
 *          Enabled, LVDS 2.5 V
 *    OUT1: 200.08 MHz [ 200 + 2/25 MHz ]
 *          Enabled, HCSL 1.8 V
 *    OUT2: Unused
 *    OUT3: Unused
 *    OUT4: Unused
 ...
 * 
 * Fpfd = 48 MHz
 * Fvco = 14.04 GHz [ 14 + 1/25 GHz ]
 * Fms0 = 1.404 GHz [ 1 + 101/250 GHz ]
 * Fms1 = 400.16 MHz [ 400 + 4/25 MHz ]
 * Fms2 = 300 MHz
 * 
 * P dividers:
 *    P0  = Unused
 ...
 *       OUT8: 27 MHz
 *    N1:
 *       Value: 35.0859656137544982... [ 35 + 215/2501 ]
 *       Skew:  0.000 s
 *       OUT0: 100.04 MHz [ 100 + 1/25 MHz ]
 *       OUT1: 200.08 MHz [ 200 + 2/25 MHz ]
 *    N2:
 ...
 * Airflow:  None
 * 
 * Total Power: 827 mW, On Chip Power: 791 mW, Tj: 87 �XC
 * 
 *          Frequency  Format   Voltage   Current     Power
 *         ----------  ------  --------  --------  --------
 * VDD                            1.8 V  142.6 mA    257 mW
 * VDDA                           3.3 V  117.4 mA    387 mW
 * VDDO0   100.04 MHz  LVDS       2.5 V   15.6 mA     39 mW
 * VDDO1   200.08 MHz  HCSL       1.8 V   16.2 mA     29 mW
 * VDDO2       Unused                                      
 * VDDO3       Unused                                      
 * VDDO4       Unused                                      
 * VDDO5       Unused                                      
 * VDDO6       26 MHz  LVDS       2.5 V   15.1 mA     38 mW
 * VDDO7       Unused                                      
 * VDDO8       27 MHz  LVDS       2.5 V   15.1 mA     38 mW
 * VDDO9      150 MHz  LVDS       2.5 V   15.9 mA     40 mW
 *                                       --------  --------
 *                                Total  337.8 mA    827 mW
 * 
 * Note:
 * 
 ...
 * -Tj is junction temperature. Tj must be less than 125 �XC (on Si5341 Revision D) for device to comply with datasheet specifications.
 * 
 * Settings
 * ========
 * 
 ...
 * 0x010E[2:0]   OUT1_FORMAT          2                  0x2              
 * 0x010E[3]     OUT1_SYNC_EN         0                  0x0              
 ...
 * 0x0235[43:0]  M_NUM                628138967040       0x09240000000    
 ...
 * 0x025C[23:0]  R6_REG               26                 0x00001A         
 * 0x025F[23:0]  R7_REG               0                  0x000000         
 * 0x0262[23:0]  R8_REG               25                 0x000019         
 * 0x0268[23:0]  R9_REG               0                  0x000000         
 * 0x026B[7:0]   DESIGN_ID0           32                 0x20             
 * 0x026C[7:0]   DESIGN_ID1           32                 0x20             
 * 0x026D[7:0]   DESIGN_ID2           32                 0x20             
 * 0x026E[7:0]   DESIGN_ID3           32                 0x20             
 * 0x026F[7:0]   DESIGN_ID4           32                 0x20             
 * 0x0270[7:0]   DESIGN_ID5           32                 0x20             
 * 0x0271[7:0]   DESIGN_ID6           32                 0x20             
 * 0x0272[7:0]   DESIGN_ID7           32                 0x20             
 * 0x0302[43:0]  N0_NUM               21474836480        0x00500000000    
 * 0x0308[31:0]  N0_DEN               2147483648         0x80000000       
 * 0x030C[0]     N0_UPDATE            0                  0x0              
 * 0x030D[43:0]  N1_NUM               92012544000        0x0156C600000    
 * 0x0313[31:0]  N1_DEN               2622488576         0x9C500000       
 * 0x0317[0]     N1_UPDATE            0                  0x0              
 * 0x0318[43:0]  N2_NUM               125627793408       0x01D40000000    
